const WORKFLOW_NODES = [
  ...
  { code: 'C4', stage: 'C. Bao bì', name: 'Thiết kế bao bì', dept: 'TK', defaultDuration: 7, defaultAfter: ['E1'] },
  ...
  { code: 'E2', stage: 'E. Công bố', name: 'Duyệt hồ sơ', dept: '', defaultDuration: 15, defaultAfter: ['E1', 'C4'] },
  ...
  { code: 'G1', stage: 'G. Sản xuất lô đầu', name: 'Xây dựng tài liệu sản xuất', dept: 'RD', defaultDuration: 7, defaultAfter: ['C5', 'E2'] },
