const WORKFLOW_NODES = [
  ...
  { code: 'B5', stage: 'B. Nghiên cứu bào chế', name: 'Chốt mẫu nghiên cứu', dept: 'BGĐ', defaultDuration: 3, defaultAfter: ['B3', 'B4'] },
  ...
  { code: 'C1', stage: 'C. Bao bì', name: 'Mẫu bao bì', dept: 'PP', defaultDuration: 7, defaultAfter: ['A1'] },
  { code: 'C2', stage: 'C. Bao bì', name: 'Ý tưởng thiết kế', dept: 'TK', defaultDuration: 7, defaultAfter: ['B5'] },
  { code: 'C3', stage: 'C. Bao bì', name: 'Thiết kế bao bì', dept: 'TK', defaultDuration: 7, defaultAfter: ['E1'] },
  { code: 'C4', stage: 'C. Bao bì', name: 'Thiết kế duyệt in', dept: 'TK', defaultDuration: 3, defaultAfter: ['E2'] },
  { code: 'D1', stage: 'D. Khả thi sản xuất', name: 'Đánh giá khả thi công bố', dept: 'PC-DV', defaultDuration: 5, defaultAfter: ['B8'] },
  { code: 'D2', stage: 'D. Khả thi sản xuất', name: 'Đánh giá khả thi sản xuất', dept: 'NCC', defaultDuration: 5, defaultAfter: ['B7'] },
  { code: 'D3', stage: 'D. Khả thi sản xuất', name: 'Pha mẫu và sửa mẫu', dept: 'NCC', defaultDuration: 20, defaultAfter: ['D2'] },
  { code: 'D4', stage: 'D. Khả thi sản xuất', name: 'Phê duyệt NCC gia công', dept: 'PP', defaultDuration: 7, defaultAfter: ['D3'] },
  { code: 'D5', stage: 'D. Khả thi sản xuất', name: 'Theo dõi độ ổn định chính thức tại nhà máy', dept: 'NCC', defaultDuration: 90, defaultAfter: ['D4'] },
  { code: 'E1', stage: 'E. Công bố', name: 'Soạn hồ sơ công bố', dept: 'PC-DV', defaultDuration: 7, defaultAfter: ['D4'] },
  { code: 'E2', stage: 'E. Công bố', name: 'Duyệt hồ sơ', dept: '', defaultDuration: 15, defaultAfter: ['E1', 'C3'] },
  { code: 'E3', stage: 'E. Công bố', name: 'Đăng ký quảng cáo', dept: 'PC', defaultDuration: 20, defaultAfter: ['E2'] },
  { code: 'F1', stage: 'F. Ra mắt & Truyền thông', name: 'Đào tạo sản phẩm', dept: 'RD', defaultDuration: 7, defaultAfter: ['E2'] },
  { code: 'F2', stage: 'F. Ra mắt & Truyền thông', name: 'Chuẩn bị launching', dept: 'Sale', defaultDuration: 30, defaultAfter: ['F1'] },
  { code: 'G1', stage: 'G. Sản xuất lô đầu', name: 'Xây dựng tài liệu sản xuất', dept: 'RD', defaultDuration: 7, defaultAfter: ['C4', 'E2'] },
  { code: 'G2', stage: 'G. Sản xuất lô đầu', name: 'Sản xuất lô đầu và kiểm nghiệm', dept: 'PP', defaultDuration: 60, defaultAfter: ['G1'] },
  { code: 'G3', stage: 'G. Sản xuất lô đầu', name: 'Kiểm tra cảm quan mẫu', dept: 'RD', defaultDuration: 2, defaultAfter: ['G2'] },
